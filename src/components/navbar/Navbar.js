...
import {loginExit} from "../../store/loginSlice";


function Navbar(){
    const userYes = useSelector(state => state.login.token);
                            ...
                            {userYes ?
                                <div className="dropdown">
                                    ...
                                    <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                        ...
                                        <li><a onClick={exitLoginBtn} className="dropdown-item" href="#">Выйти</a></li>
                                    </ul>
                                </div>
